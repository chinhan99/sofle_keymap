...
#define ISLAND_CALM 10         // WPM at which the palm tree calmly moves
#define ISLAND_HEAVY_STORM 20  // WPM at which the heavy storm occurs
#define ISLAND_HURRICANE 40    // WPM at which THE HURRICANE STARTS
